...
public enum MediaShareAuthMode: Equatable, Sendable {
...
public enum MediaShareTrustKind: Equatable, Sendable {
...
public enum PlaintextCredentialRisk: Equatable, Sendable {
...
public struct TransportOnboardingDescriptor: Sendable {
    public let kind: MediaShareTransportKind
    ...
    public let allowsBlankGuest: Bool
    public let plaintextCredentialRisk: PlaintextCredentialRisk

    // MARK: Approve trust
    public let trust: MediaShareTrustKind
    ...
    /// picks the label.
    public let listsSharesNotFolders: Bool
...
public enum MediaShareTransportCatalog {
    public static let all: [TransportOnboardingDescriptor] = [
    ...
    public static func descriptor(for kind: MediaShareTransportKind) -> TransportOnboardingDescriptor? {
    ...
    public static let preferenceOrder: [MediaShareTransportKind] = [.smb, .nfs, .webDAV, .sftp, .ftp]

    /// The best default door among a set of detected transports.
    public static func preferredKind(among kinds: [MediaShareTransportKind]) -> MediaShareTransportKind? {
