...
public extension ThemePalette {
    ...
    /// gradient so the background gently shifts rather than banding. Its greys
    /// are centred on the brand background base (`#2e2e30`) generated by
    /// `tools/generate_brand_assets.py`, fading darker toward the edges.
    static let dark = ThemePalette(
        backgroundBase: Color(red: 0.18, green: 0.18, blue: 0.19),
        backgroundSecondary: Color(red: 0.10, green: 0.10, blue: 0.11),
    ...
    static let oled = ThemePalette(
        backgroundBase: Color(red: 0.04, green: 0.04, blue: 0.05),
